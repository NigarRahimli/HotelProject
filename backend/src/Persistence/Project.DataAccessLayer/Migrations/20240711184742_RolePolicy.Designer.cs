...
namespace Project.DataAccessLayer.Migrations
{
    ...
    [Migration("20240711184742_RolePolicy")]
    partial class RolePolicy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Domain.Models.Entities.Membership.Policy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Policies", "Membership");
                });

            modelBuilder.Entity("Project.Domain.Models.Entities.Membership.RolePolicy", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Domain.Models.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Domain.Models.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.Domain.Models.Entities.Membership.RolePolicy", b =>
                {
                    b.HasOne("Project.Domain.Models.Entities.Membership.Policy", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project.Domain.Models.Entities.Transaction", b =>
                {
                    b.HasOne("Project.Domain.Models.Entities.Reservation", null)
                        .WithMany()
